...
function ajax_load_posts(){
  ...
  //3 ajouter des paramétres dans le customizer
// Ajouter des paramètres de thème dans le personnalisateur WordPress
function add_custom_theme_settings($wp_customize) {
	// Paramètre pour afficher la recherche dans le footer
	$wp_customize->add_setting('has_footer_search', array(
	  'default' => false,
	  'transport' => 'refresh',
	));
	$wp_customize->add_control('has_footer_search', array(
	  'label' => 'Afficher la recherche dans le footer',
	  'type' => 'checkbox',
	  'section' => 'title_tagline',
	));
  
	// Paramètres pour les URL des réseaux sociaux
...
//4 Ajouter un emplacement de menu
function register_footer_menu() {
  ...
  //5 Créer une zone de widgets dans le footer
function create_footer_widget_area() {
	register_sidebar(array(
	  'name' => 'Zone de widgets du footer',
	  'id' => 'footer-widget-area',
	  'description' => 'Cette zone de widgets se situe au-dessus du formulaire de recherche dans le footer.',
